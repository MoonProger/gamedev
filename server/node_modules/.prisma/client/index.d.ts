...
export namespace Prisma {
  ...
  */
  ...
  export type RoomOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "title" | "status" | "settings" | "createdAt" | "creatorId", ExtArgs["result"]["room"]>
  ...
  export type RoomPlayerOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"roomId" | "userId" | "joinedAt" | "isReady", ExtArgs["result"]["roomPlayer"]>
  ...
  export interface RoomPlayerDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
     * 
     * // Update zero or more RoomPlayers and only return the `roomId`
     * const roomPlayerWithRoomIdOnly = await prisma.roomPlayer.updateManyAndReturn({
     *   select: { roomId: true },
     *   where: {
     *     // ... provide filter here
     *   },
